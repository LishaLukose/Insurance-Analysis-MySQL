...
#KPI-2 Total Customers Hold One or More Policies
...
inner join policy_details p on c.Customer_ID = p.Customer_ID;
...
#KPI-6 Policy Expiring This Year
...
end as Claim_Status,count(distinct Policy_ID) as policy_count
